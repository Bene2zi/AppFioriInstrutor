		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aluno 99",
									"targetURL": "#AppFioriAluno99appfiorialuno99-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AppFioriAluno99appfiorialuno99-display": {
								"semanticObject": "AppFioriAluno99appfiorialuno99",
								"action": "display",
								"description": "Aluno 99 Fiori application.",
								"title": "Aluno 99",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AppFioriAluno99.appfiorialuno99",
									"url": sap.ui.require.toUrl("AppFioriAluno99/appfiorialuno99")
								}
							}
						}
					}
